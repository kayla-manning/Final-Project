...
tidy_int_reg_bag %>% 
  ...
  labs(title = "Daily Distribution of Fly-By Traffic",
       subtitle = "Comparing median swip counts for the 2017-2018 and 2018-2019 \nacademic years") +
  scale_fill_discrete(name = "Academic Year",
                      labels = c("2017-2018", "2018-2019")) +
...
tidy_int_reg_bag %>% 
  ...
  geom_col(position = "dodge") +
  labs(title = "Daily Distribution of Fly-By Traffic",
       subtitle = "In terms of median swipe counts for the 2017-2018 academic year") +
  scale_fill_discrete(name = "Academic Year",
                      labels = c("2017-2018")) +
  xlab("Day of the Week") +
  ylab("Median Swipe Count")
...
tidy_int_reg_bag %>% 
  ...
  geom_col(position = "dodge") +
  labs(title = "Daily Distribution of Fly-By Traffic",
       subtitle = "In terms of median swipe counts for the 2018-2019 academic year") +
  scale_fill_discrete(name = "Academic Year",
                      labels = c("2018-2019")) +
  xlab("Day of the Week") +
  ylab("Median Swipe Count")
